...
(Longitudinal modelling and include simulation of baseline are available 
...
or worsening for the participant. 

REWRITE: The value provided here informs the <span class="custom-tooltip"> direction
