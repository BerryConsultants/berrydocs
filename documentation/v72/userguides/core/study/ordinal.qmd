...
then an arm with an odds ratio smaller than 1 is superior to control.  
If the user has selected Dirichlet modeling, then for the purpose of posterior probability 
quantities and t-tests, an arm that is superior to control is one with a large expected utility, 
