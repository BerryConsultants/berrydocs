...
$\sim\mu_{g,a,1} + N\left( 0,\sigma_{g,a,1}^{2} \right)$
...
$\sim f_{g,t}\left( \mu_{g,a} + \delta_{i} \right) + N\left( 0,\kappa_{g,a,t}^{2} \right)$
...
$$
\propto \left( \frac{1 - \exp\left( kv_{t} \right)}{1 - \exp\left( kv_{T} \right)} \right)
$$
