...
subtitle: "Also supported under Microsoft Windows"
format: 
  html:
    toc: true
    toc-depth: 4
...
-\[useDifferentSeedPerScenario\] – Flag indicating whether to use a
different seed for each simulated scenario. Default (False).

-\[useDifferentSeedPerDesign\] – Flag indicating whether to use a
different seed for each simulated design. Default (False).
