...
4.  [Early stopping rules](successfutility.qmd): in an adaptive trial the user can select the
...
5.  [Final evaluation criteria](successfutility.qmd): the same Bayesian evaluation criteria are
