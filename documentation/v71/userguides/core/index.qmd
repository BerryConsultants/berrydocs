...
-   The Virtual Subject Response tabs are for specifying the simulation
    of subject responses. This is either by specifying response rates
    for each other treatment arms, or by supplying external data files
    of simulated subject responses. Supplied external data files must
    contain the time to event of subject's given the treatment arm they
...
-   The Design tabs are for specifying the statistical analysis to be
    ...
    take at interims and how to determine if the overall trial has been
    successful. The expected consequences of these design choices are
    then estimated by running simulations of the trials using the
