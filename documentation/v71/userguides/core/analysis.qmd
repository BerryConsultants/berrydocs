...
file ([continuous/dichotomous](./simulation/contanddichot.qmd#contents-of-patientsnnnnn.csv) or [time-to-event](./simulation/tte.qmd#contents-of-patientsnnnnn.csv)), and the column values described above.
