...
![The blank analysis tab.](./coreUGattachments/continuous/media/image79.png){#fig-analysis}
...
![The analysis tab after clicking "Use Design to Analyze Data"](./coreUGattachments/continuous/media/image80.png){}
...
![The analysis tab when selecting a file to use in the analysis.](./coreUGattachments/continuous/media/image81.png){}
...
weeks](## "This value is in weeks from FACTS 7.0 onwards, before that it was in days.")
from the start of the trial. It is output from FACTS
...
![The Analysis tab after running the analysis. The trial result is in the box to the left - the success criteria have been met.](./coreUGattachments/continuous/media/image86.png){#fig-analysisresultscont}

### Dichotomous

![The Analysis tab after running the analysis. The trial result is in the box to the left - no interim stopping criteria have been met.](./coreUGattachments/dichotomous/media/image82.png){#fig-analysisresultsdich}
