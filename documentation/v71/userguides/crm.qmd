...
![Study info - 2 group options with open enrolment](images/clipboard-2033701160.png){#fig-sec-study-study4}
...
![](images/clipboard-809393512.png){#fig-sec-study-study5}

Simulating an additional efficacy outcome is simply specified by checking the “include efficacy” checkbox.

![Study tab with "Include efficacy" checked](images/clipboard-1015659566.png){#fig-sec-study-study6}
...
![Toxicity tab targeting a toxicity band](images/clipboard-1584639963.png){#fig-sec-study-tox1}
...
![N-CRM, targeting a single dose, not a toxicity band](images/clipboard-3531590179.png){#fig-sec-study-tox-single1}
...
![The Efficacy tab](images/clipboard-2054926457.png){#fig-sec-study-eff1}
...
![The Treatment Arms tab specifying explicit doses](images/clipboard-1708615787.png){#fig-sec-study-ta1}
...
![The Treatment Arms tab, specifying a finely spaced dose range](images/clipboard-1521668862.png){#fig-sec-study-ta-fgd1}
...
![The Variants tab, specifying 5 variants](images/clipboard-3721505559.png){#fig-sec-study-var1}
...
![Explicitly defined toxicity - binary endpoint](images/clipboard-4185184244.png){#fig-sec-vsr-ex1}
...
![Virtual Subject Response – Explicitly-Defined – ordinal endpoint](images/clipboard-3668848689.png){#fig-sec-vsr-ex2}
...
![Virtual Subject Response – Explicitly-Defined: Ordinal Toxicity tab](images/clipboard-4019572525.png){#fig-sec-vsr-ex-ord1}
...
![Explicitly defined toxicity - 2 groups](images/clipboard-27213182.png){#fig-sec-vsr-ex-ex2g1}
...
![Explicitly defined toxicity - 2 groups and ordinal offsets](images/clipboard-2521844099.png){#fig-sec-vsr-ex-ex2g2}
...
![Explicitly Defined, Ordinal Toxicity with 2 Groups](images/clipboard-4265246160.png){#fig-sec-vsr-ex-ord2g1}
...
![Efficacy virtual subject response, explicitly defined](images/clipboard-1657858868.png){#fig-sec-vsr-ex-exeff1}
...
![Explicity defined efficacy response profile with 2 groups](images/clipboard-1755902621.png){#fig-sec-vsr-ex-eff2g1}
...
![Virtual Subject Response - Parametric Toxicity tab](images/clipboard-4187069952.png){#fig-sec-vsr-par1}
...
![Virtual Subject Response - Parametric Toxicity tab with Ordinal toxicity](images/clipboard-705500554.png){#fig-sec-vsr-par2}
...
![Parametric definition of ordinal toxicity response with 2 groups](images/clipboard-2750595441.png){#fig-sec-vsr-par3}
...
![Parametric efficacy response profile](images/clipboard-2515320149.png){#fig-sec-vsr-par-eff1}
...
![External Data](images/clipboard-3075146140.png){#fig-sec-vsr-ext1}
...
![Specifying the dose transformation - the "x-hats".](images/clipboard-2199440383.png){#fig-sec-des-xh1}
...
![Design - Toxicity Response sub-tab (after prior derivation)](images/clipboard-924511466.png){#fig-sec-des-tox-prior5}
...
![Derivation from a legacy prior](images/clipboard-1528418031.png){#fig-sec-des-tox-prior-leg1}
...
![](images/clipboard-3052137711.png){#fig-sec-des-tox-prior-eff1}
...
![Specifying prior pseudo subjects](images/clipboard-486692236.png){#fig-sec-des-tox-prior-ps1}

| Example of effect of pseudo subjects on prior |   |
|------------------------------------|:-----------------------------------|
| Prior Only | ![](images/clipboard-20543065.png) |
| Prior plus 0.5/0 subjects toxicities on dose 1 and 1/0.5 on dose 8. | ![](images/clipboard-1742941756.png) |
| Prior plus 3/0 subjects / toxicities on dose 1 and 3/1.5 on dose 8. | ![](images/clipboard-516836495.png) |
...
![](images/clipboard-4098696863.png){#fig-sec-des-tox-prior-alloc1}
...
![Maximum dose increment varying by number of toxicities observed](images/clipboard-2553981648.png){#fig-sec-des-tox-prior-alloc2}
...
![Maximum dose increment varying by dose level](images/clipboard-1610266189.png){#fig-sec-des-tox-prior-alloc3}
...
![Design - Allocation Rule Initial Dose Second Group](images/clipboard-2316708456.png){#fig-sec-des-tox-prior-alloc4}
...
![Allocation rules with a finely spaced doses](images/clipboard-2435202614.png){#fig-sec-des-tox-prior-alloc-fgd1}
...
![Backfill Allocation](images/clipboard-3668815882.png){#fig-sec-des-tox-prior-bf1}
...
![Design - Stopping Criteria sub tab](images/clipboard-3965543388.png){#fig-sec-des-tox-prior-sc1}
...
![Stopping Criteria tab with open enrolment and finely spaced doses](images/clipboard-3642157716.png){#fig-sec-des-tox-prior-sc2}
...
![Stopping Criteria tab with open enrolment and both a toxicity and efficacy endpoint](images/clipboard-1886135383.png){#fig-sec-des-tox-prior-sc3}
...
![Simulation](images/clipboard-3509335704.png){#fig-sec-sim1}
...
![Simulation tab showing variants](images/clipboard-1839823179.png){#fig-sec-sim2}
...
![](images/clipboard-1013451560.png){#fig-sec-sim-mcmc1}
...
![Detailed Simulation Results for a particular scenario](images/clipboard-1034836642.png){#fig-sec-sim-res1}
...
![Cohort Results for a particular simulation](images/clipboard-645498849.png){#fig-sec-sim-res2}
...
![](images/clipboard-4250106689.png){#fig-sec-sim-agg1}
