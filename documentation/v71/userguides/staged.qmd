...
-   [Continuous/Dichotomous/Multiple Endpoint](./core/execution.qmd#continuousdichotomous)

-   [Time-to-Event](./core/execution.qmd#time-to-event)
...
![The Transition > Dose Selection > All Dose Decisions tab that keeps 1 or 2 doses depending on how many have Pr($\theta$_d-$\theta$_(Control) > 1).](./stagedUGattachments/media/image17.png){#fig-transitionalldose}
...
Fixed allocation in Stage 2 is specified in the [same was as FACTS Core](./core/design/allocation.qmd#fixed-allocation)
...
In Stage 2 the "Success/Futility Criteria" tab is [the same as in FACTS Core](./core/design/successfutility.qmd),
and differs from the Stage 1 Design \> Success/Futility/Graduation Criteria
tab in not having any graduation criteria conditions.

See the [Stage 2 Interims tab description](#interims) for some details on Success/Futility
rules if interims are unattainable or already attained at the start of Stage 2.
...
[Graphs available for time-to-event core designs](./core/simulation/multendpt.qmd#graphs-of-simulation-results)
...
Core: [Time Course for Stopping/Graduation](#time-course-graphs), [Proportion Times Arms Selected](#proportion-of-times-arms-selected), and [Numbers of Arms Selected](#number-of-arms-selected)
...
based on Stage 2. There are 3 additional graphs not in FACTS Core: [Time Course for Stopping](#time-course-graphs), [Outcomes by Arms Selected](#stage-2---outcomes-by-arms-selected), and [Outcomes by Number of Arms Selected](#stage-2---outcomes-by-number-of-arms-selected)
...
-   "Selected" -- the arm was correctly selected for graduation (it was selected and marked as "Should succeed" on the VSR tab) and the trial graduated to Stage
    2.
