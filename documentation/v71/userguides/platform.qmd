...
The platform trials engine QOI tab is largely the same as the [FACTS Core QOI tab](../userguides/core/qois/index.qmd),
...
[pick a single value of a QOI that should be compared to a threshold](../userguides/core/qois/index.qmd#decision-quantities). This is
...
for [FACTS Core](./core/qois/index.qmd#future-trial-bayesian-predictive-probabilities) (prediction of a separate trial with 1:1
