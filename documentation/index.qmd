...
- User Guides: Access detailed manuals covering the full range of our engines. From foundations to advanced features, learn how to set up your desired trial design, learn about best practices and obtain focused understanding of the subject matter, and troubleshoot common issues.
    ...
    - [3+3 and mTPI - Rule Based Dose Escalation](v72/userguides/de.qmd)
    - [Phase II & III Designs](v72/userguides/core/index.qmd)
    - [Seamless Designs](v72/userguides/staged.qmd)
    - [Enrichment Designs](v72/userguides/enrichment/index.qmd)
    - [CRM - Model Based Dose Escalation](v72/userguides/crm.qmd)
    - [2D CRM - 2D Model Based Dose Escalation](v72/userguides/2dcrm.qmd)
    - [FACTS/R - How to Call FACTS from R](v72/userguides/FACTSfromR.qmd)
    - [FLFLL - FACTS Linux File Loader Light](v72/userguides/flfll.qmd)
    - [Platform Trials](v72/userguides/platform.qmd)
    - [FACTS Design Report](v72/userguides/dr.qmd)
