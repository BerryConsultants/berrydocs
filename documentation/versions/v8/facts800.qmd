...
- In Core and Staged designs, if the allocation proportion given to adaptively allocated arms is equal to the threshold specified to zero out randomization probabilities, FACTS now correctly drops all adaptively allocated arms except for the single best arm.
