...
In the current version there is a single statistical model used to
...
window to a free floating one that can be moved away from the FACTS
...
- Stop when Posterior Probability of target Toxicity at MTT is at least:
...
interaction term η (Eta) is the mean and Sd of a Normal distribution. Using a Normal prior for Eta allows Eta to be -ve, modeling a negative interaction between the drugs and resulting in a non-monotonic surface. Unless a negative interaction is thought possible, it is recommended that the lognormal prior for Eta is used
...
| True mean Tox | 1 | The mean (over the simulations) of the true probabilities of toxicity that subjects have been exposed to. |
...
| Ppn All Toxic Early Stop | 1 | The proportion of the simulations that stopped early (i.e. before the maximum sample size was reached) because all combinations were judged too toxic (exceeded the overdose control limit). |
...
![](2dcrmUGattachments/images/image30.png){#fig-fig30}
...
![](2dcrmUGattachments/images/image31.png){#fig-fig31}
...
![](2dcrmUGattachments/images/image32.png){#fig-fig32}
...
![](2dcrmUGattachments/images/image33.png){#fig-fig33}
...
![](2dcrmUGattachments/images/image34.png){#fig-fig34}
...
![](2dcrmUGattachments/images/image35.png){#fig-fig35}
...
![](2dcrmUGattachments/images/image36.png){#fig-fig36}
...
![](2dcrmUGattachments/images/image37.png){#fig-fig37}
...
![](2dcrmUGattachments/images/image38.png){#fig-fig38}
...
![](2dcrmUGattachments/images/image39.png){#fig-fig39}
...
![](2dcrmUGattachments/images/image40.png){#fig-fig40}
...
![](2dcrmUGattachments/images/image41.png){#fig-fig41}
...
![](2dcrmUGattachments/images/image42.png){#fig-fig42}
...
![](2dcrmUGattachments/images/image43.png){#fig-fig43}

After clicking the button the tab becomes active,

![](2dcrmUGattachments/images/image44.png){#fig-fig44}

and an “Analysis” folder is created alongside the folder that hold the
simulation results.

![](2dcrmUGattachments/images/image45.png){#fig-fig45}
...
![](2dcrmUGattachments/images/image46.png){#fig-fig46}
...
![](2dcrmUGattachments/images/image47.png){#fig-fig47}
...
![](2dcrmUGattachments/images/image48.png){#fig-fig48}
...
![](2dcrmUGattachments/images/image49.png){#fig-fig49}
...
![](2dcrmUGattachments/images/image50.png){#fig-fig50}
...
![](2dcrmUGattachments/images/image51.png){#fig-fig51}
...
![](2dcrmUGattachments/images/image52.png){#fig-fig52}
