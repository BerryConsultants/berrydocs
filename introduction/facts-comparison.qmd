---
title: "FACTS vs EAST, rpact and ADDPLAN"
description: "Learn how FACTS, Berry Consultants' Bayesian clinical trial design software, differs from EAST, rpact and ADDPLAN for adaptive clinical trial simulation."
keywords:
  - Bayesian clinical trial design
  - Bayesian clinical trial software
...
While software such as **Cytel's EAST**, **rpact**, and **ADDPLAN** focus primarily on 
...
simulate different scenarios (where each scenario is a different possile "truth") thousands of times, 
...
| Statistical framework | Strong support for Bayesian designs | Primarily frequentist |
...
**In summary:** FACTS is a specialised **Bayesian clinical trial simulation platform** designed to evaluate **adaptive and innovative clinical trial designs**, while EAST, rpact and ADDPLAN are primarily analytical tools aimed at traditional frequentist trial design and sample size calculation.
