...
- During FACTS installation you will have to option to enable FACTS to report Analytics to the Berry software team. This allows us to see FACTS crash reports, how much FACTS is used and which features in FACTS are being used. Collected data is user-level anonymized but organization-level identifiable i.e. the organization name will be known but not the associated user. Enabling this setting would help significantly improve the user experience of FACTS. 
