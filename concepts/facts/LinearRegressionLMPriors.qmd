...
server <- function(input, output, session) {
  ...
  df = data.frame(VisitResponse = 1:5,
                  alphaPriorMean = 0,
                  alphaPriorSD = 2,
                  betaPriorMean = 1,
                  betaPriorSD = 2,
  ...
  output$priorPredictive = renderPlot({
   ...
   # lvIndex = lvIndex + 1
   # finalVisitIndex = finalVisitIndex + 1
    ...
    p1 = p1 + scale_fill_manual(labels = c("Prior distribution for mean of imputed value.", "Prior predictive distribution for final endpoint of subject.")) +
      guides(fill = guide_legend(override.aes = list(labels = c("Prior distribution for mean of imputed value.", "Prior predictive distribution for final endpoint of subject.")))) 
